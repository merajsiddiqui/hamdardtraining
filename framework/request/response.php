...
/**
 * Response class is responsible for processing the results of the HTTP request
 * It accepts a response constructor option, which is the result of an HTTP request.
 * It splits this response string into headers and a body, which are available through getter methods.
 *
